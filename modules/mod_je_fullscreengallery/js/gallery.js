...
$(window).load(function() {
	...
	if($defaultViewMode=="full"){
		$toolbar_a.html("<div class='toolbar_n_icon'></div>").attr("onClick", "ImageViewMode('normal');return false").attr("title", "Restore");
	} else {
		$toolbar_a.html("<div class='toolbar_fs_icon'></div>").attr("onClick", "ImageViewMode('full');return false").attr("title", "Maximize");
	}
	...
	$(window).resize(function() {
		FullScreenBackground("#bgimg-malihu",$bgimg.data("newImageW"),$bgimg.data("newImageH"));
