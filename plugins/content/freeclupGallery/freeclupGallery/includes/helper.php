...
class SimpleImageGalleryHelper {
	...
	static function renderGallery($srcimgfolder,$cacheFolder,$thb_width,$thb_height,$smartResize,$jpg_quality,$cache_expire_time){
	...
	static function thumbDimCalc($width,$height,$thb_width,$thb_height,$smartResize){
